        ...
        <div class="col-xl-9 pull-xl-3 col-lg-8 pull-lg-4 col-md-7 pull-md-5 col-sm-12 pull-sm-0"> 
            ...
            <div class="row">
                <div class="col">
                    ...
                    <h3>Next insurance fee <span id="clock251"></span></h3>
					<script>
                        // Count down  
                        $('#clock251').countdown('2018/09/10', function(event) {
                            ...
                            <tbody> 
                                <tr>
                                    <td class="alert-success text-center">
                                        ...
                                        <div>Bonus for regular fee</div>
									</td>
                            		<td class="price-td"><strong class="text-success">1 MPT</strong></td>
                                ...
                                <tr>
                                    ...
                                    <td> 
										<div class="card">
                        					<ul>
												<li>Transaction code <span id="transactionId">Ghhhsbb$hfhjaj77ghsFGGDa91PPvDa</span></li>
                								<li><a class="copy-link btn-copy2" onclick="copyToClipboard('#transactionId')"><i class="far fa-copy"></i> Copy</a> / <a href="#" data-toggle="modal" data-target="#sorry">Check in blockchain explorer</a></li>
                        						<li>Transaction status <span class="text-success">Success</span> <small class="float-right">confirmations 5/5</small></li> 
											</ul>
										</div><!--/.card-->
									</td> 
