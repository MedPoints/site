    		...
    		<form>
        		...
        		<div class="row">
            		<div class="col-xl-8 col-lg-7 col-md-12 col-sm-12">
						...
						<div class="form-group row">
                    		<label for="tickeText" class="col-2 col-form-label">Text</label>
        					<!--/.col--> 
                			<div class="col-10">
                    			<textarea name="textarea" class="form-control" id="tickeText" placeholder="Ticket text"></textarea>
							</div>
        					<!--/.col--> 
                		</div> 
                		...
                		<nav class="sticky-top">
                    		...
                    		<div class="wave">
                        		...
                        		<div class="form-group">
									<a class="btn btn-primary justify" href="#">Add ticket</a>  
								</div>  
