...
<?php
    ...
    $page_name = 'account-favorites';
    $page_title = 'Account Favorites';
	$page_keywords = '';
	$page_description = '';
    ...
    <div class="row">
        ...
        <div class="col-xl-9 pull-xl-3 col-lg-8 pull-lg-4 col-md-7 pull-md-5 col-sm-12 pull-sm-0"> 
    		...
    		<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">Doctors</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">Pharmacies</a>
                </li>
            </ul>
			...
			<div class="row pagination-line">
          	...
          	<!--/.row-->
                ...
                <!--/.tab-pane-->
                <div class="tab-pane fade" id="pills-3" role="tabpane3" aria-labelledby="pills-contact-tab">
                    Doctors
                </div>
                <!--/.tab-pane-->
                <div class="tab-pane fade" id="pills-4" role="tabpane4" aria-labelledby="pills-contact-tab">
                    Pharmacies
                </div>
                <!--/.tab-pane-->
            </div>
