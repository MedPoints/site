    ...
    <form>
        ...
        <div class="row">
                ...
                <nav class="sticky-top">
                    ...
                    <div class="wave">
                        ...
                        <div class="history">
                            ...
                            <h3>Provider: <a href="/clinic">General Hospital</a> <small>Public</small></h3>
                            <h3>Start date: 14.05.2018</h3>
                        ...
                        width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                            ...
                            <ul class="stiled-list">
                                <li>
                                    <h4>Fracture of bones</h4> 
                                    <p>Price <strong>100 MPT</strong> per month</p>
                                </li>
                                <li>
                                    <h4>Burns of skin and mucous membranes</h4> 
                                    <p>Price <strong>100 MPT</strong> per month</p>
                                </li>
                                <li>
                                    <h4>Damages to internal organs</h4> 
                                    <p>Price <strong>500 MPT</strong> per month</p>
                                </li>
                                <li>
                                    <h4>Circulatory system diseases</h4> 
                                    <p>Price <strong>100 MPT</strong> per month</p>
                                </li> 
                            </ul>
                            ...
                            <div>Total cost <strong>800 MPT</strong> per month</div>
            ...
            <div class="col-xl-8 col-lg-8 col-md-12">
                ...
                <h2>Subject of medical insurance</h2>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <select class="custom-select mb-2 mr-sm-2 mb-sm-0 justify" id="countryOfResidence">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="lastName" class="form-control" id="address" placeholder="Address" required />
                    </div>
                    <!--/.col--> 
                </div>
                <!--/.row-->
                ...
                <div class="row"> 
                    <div class="col-12">
                        <label class="custom-control custom-checkbox">
							...
							<span class="custom-control-indicator"></span>
							<span class="custom-control-description">Fracture of bones</span>
						</label>
                    </div>
                    <!--/.col-->
                    <div class="col-12">
                        <label class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input">
							<span class="custom-control-indicator"></span>
							<span class="custom-control-description">Burns of skin and mucous membranes</span>
						</label>
                    </div>
                    <!--/.col-->
                    <div class="col-12">
                        <label class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input">
							<span class="custom-control-indicator"></span>
							<span class="custom-control-description">Damages to internal organs</span>
						</label>
                    </div>
                    <!--/.col-->
                    <div class="col-12">
                        <label class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input">
							<span class="custom-control-indicator"></span>
							<span class="custom-control-description">Circulatory system diseases</span>
						</label>
                    </div>
                    <!--/.col-->
                </div>
				...
				<div class="row">
					<div class="col">
						<a class="btn btn-primary justify" href="/success">Confirm the creation of an insurance policy</a>
						<br />
					</div>
					<!--/.col-->
					<div class="col text-right">
						<a class="btn btn-secondary justify" href="">checkout with Paypal</a>
					</div>
					<!--/.col-->
				</div>
				<!--/.row-->
